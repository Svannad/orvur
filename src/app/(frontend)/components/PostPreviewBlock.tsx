...
export default function PostPreviewBlock({ block }: { block: PostPreviewProps }) {
  ...
  return (
    <section className="py-12 pl-8 lg:pl-24 2xl:pl-41">
      <div className="flex w-full justify-between items-center pr-8 lg:pr-24 2xl:pr-41">
        {block.maintitle && (
      ...
      <Carousel className="relative w-full mb-42">
        <CarouselContent>
          {posts.length > 0 ? (
            ...
            <div className="w-full text-center py-10 text-gray-500">No posts available.</div>
          )}
        </CarouselContent>
      </Carousel>
    </section>
