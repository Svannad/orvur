...
export default async function Page({ params }: { params: { slug: string; id: string } }) {
  ...
  return (
    <article className="py-28 pl-24 2xl:pl-41 w-full">
      <header className=" mb-5 grid grid-cols-[1fr_auto] pt-20 items-start gap-6 pr-24 2xl:pr-41">
        {/* Title + Subtitle */}
        ...
        {/* Vertical gold line */}
        <div className="w-0.5 bg-yellow h-full mr-[235px] 2xl:mr-[158px]" />
      </header>
      ...
      {heroImage?.url && (
        <div className="relative w-full aspect-video mb-5 overflow-hidden h-[650px]">
          <Image
            ...
            fill
            className="object-cover pr-24 2xl:pr-41"
          />
        </div>
      )}
